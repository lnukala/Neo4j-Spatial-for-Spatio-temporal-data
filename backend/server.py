...
url = 'http://192.168.1.117:5000/boundingboxtemp/'
...
# payload = {"query" : "start node = node:2015-08-17('bbox:[113.79947662353516,114.12975311279297,22.522388566344084.22.655838847314328]') return node"}
# r = requests.post(url, data=json.dumps(payload), auth=('neo4j', '18843'))
# print r.content
# print r.status_code
